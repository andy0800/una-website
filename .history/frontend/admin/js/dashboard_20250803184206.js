...
let currentEditId = null; // Track which item is being edited
            ...
            html += `
                <tr>
                    ...
                    <td style="max-width: 300px; word-wrap: break-word;">
                        ${courseBadges || 'No courses assigned'}
                    </td>
                    <td>
...
function saveUserEdit() {
    const userData = {
        ...
        courses: Array.from(document.getElementById('editUserCourses').selectedOptions).map(option => option.value)
    };
