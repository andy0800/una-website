...
function startLiveStream() {
    ...
    try {
        ...
        // Create separate audio element for admin to hear the stream
        ...
        // Set audio source to stream for admin to hear
        adminAudio.srcObject = stream;
        adminAudio.muted = false; // Admin should hear the audio
        adminAudio.volume = 0.5; // Set reasonable volume
        adminAudio.play().catch(e => console.log('Audio autoplay prevented:', e));
...
function startMediaRecorder(lectureId) {
    try {
        ...
        // Smart fallback to best supported format
        const supportedFormats = [
            { mimeType: 'video/webm;codecs=vp9', name: 'VP9 (High Quality)', quality: 'high' },
            { mimeType: 'video/webm;codecs=vp8', name: 'VP8 (Good Quality)', quality: 'medium' },
            { mimeType: 'video/webm', name: 'WebM (Basic)', quality: 'basic' }
        ];
