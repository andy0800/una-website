...
function loadCourses() {
    ...
    .catch(error => {
        ...
        document.getElementById('coursesContent').innerHTML = '<p>Error loading courses</p>';
    });
}
    ...
    content.innerHTML = `
        <div class="dashboard-overview">
            <div class="stat-card">
                ...
                <div class="trend">+${stats.userGrowth || 0}% this month</div>
            </div>
            <div class="stat-card">
                <h3>Active Courses</h3>
                <div class="number">${stats.activeCourses || 0}</div>
                <div class="trend">+${stats.courseGrowth || 0}% this month</div>
            </div>
            <div class="stat-card">
                <h3>Total Revenue</h3>
                <div class="number">$${stats.totalRevenue || 0}</div>
                <div class="trend">+${stats.revenueGrowth || 0}% this month</div>
            </div>
        </div>
    `;
}
...
function loadForms() {
    ...
    .catch(error => {
        ...
        document.getElementById('formsContent').innerHTML = '<p>Error loading forms</p>';
    });
}
