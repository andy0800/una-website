...
// 🚀 LIVESTREAM FUNCTION - WILL BE REPLACED WITH JITSI
async function startLiveStream() {
    ...
    try {
        ...
        if (window.audioPipeline) {
            ...
            const success = await window.audioPipeline.init();
            if (!success) {
                throw new Error('Failed to start stream - check console for details');
            }
