...
window.audioPipeline = {
    ...
    joinChannel: async function() {
        ...
        try {
            ...
            // If no token and useToken is false, try to join without token
            if (!token && window.AGORA_CONFIG.useToken === false) {
                console.log('🔄 Attempting to join channel without token...');
