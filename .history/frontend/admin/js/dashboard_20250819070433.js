...
function startLiveStream() {
    ...
    try {
        ...
        // First try to get audio only to test microphone permissions
        ...
        .catch(error => {
            ...
            if (error.name === 'NotAllowedError') {
                ...
                detailedMessage = 'Your device cannot meet the required video/audio specifications. Trying with lower quality...';
                ...
                .then(stream => {
                    console.log('✅ Lower quality stream obtained');
                    localStream = stream;
                    ...
                    const streamStatus = document.getElementById('streamStatus');
                    if (streamStatus) {
                        streamStatus.textContent = '🟡 LIVE - Lower Quality';
                        streamStatus.className = 'status-live';
                    }
                ...
                .catch(lowerError => {
                    console.error('❌ Even lower quality failed:', lowerError);
                    alert('Unable to start stream with any quality settings. Please check your device and try again.');
                });
                
                return; // Don't show the main error alert
            } else {
