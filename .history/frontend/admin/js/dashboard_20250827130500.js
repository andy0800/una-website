...
async function initializeWebRTCManager() {
    try {
        if (typeof CustomWebRTCManager !== 'undefined') {
            ...
            if (success) {
                console.log('✅ Custom WebRTC Manager initialized successfully');
                return true;
            } else {
...
window.audioPipeline = {
    ...
    init: async function() {
        try {
            console.log('🚀 Initializing Custom WebRTC livestreaming system...');
            
            // Initialize WebRTC manager
            const success = await initializeWebRTCManager();
            if (success) {
                this.isInitialized = true;
                console.log('✅ Custom WebRTC system initialized successfully');
                return true;
            } else {
    ...
    startLivestream: async function(roomType = 'livestream', roomName = null) {
        try {
            ...
            if (result && result.success) {
                ...
                console.log('✅ Livestream started successfully:', result.roomId);
                return result;
            } else {
    ...
    startScreenShare: async function() {
        try {
            console.log('🖥️ Screen sharing not yet implemented in Custom WebRTC');
    ...
    setAdminAudio: function(stream) {
        console.log('🎤 Admin audio stream set - handled by Custom WebRTC');
        return true;
    },
