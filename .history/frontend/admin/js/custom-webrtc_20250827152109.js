    ...
    setupSocketListeners() {
        ...
        this.socket.on('viewer-join', ({ socketId, userInfo, viewerCount }) => {
            ...
            if (this.roomId) {
                ...
                console.log('⏳ Waiting for room ID before creating peer connection for viewer:', socketId);
        ...
        this.socket.on('stream-started', (data) => {
            ...
            if (data.roomId) {
                ...
                console.log('✅ Room ID set from stream start:', this.roomId);
                
                // Now create peer connections for any pending viewers
                if (this.pendingViewers && this.pendingViewers.size > 0) {
                    console.log('🔄 Creating peer connections for pending viewers:', this.pendingViewers.size);
        ...
        try {
            ...
            if (localVideo) {
                ...
                localVideo.play().catch(error => {
                    console.log('⚠️ Auto-play prevented, user may need to interact first');
                });
