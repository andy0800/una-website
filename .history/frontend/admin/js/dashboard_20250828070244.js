...
// 🚀 NEW: Enhanced audio testing and control functions
function testAdminAudio() {
    try {
        if (!window.webrtcManager || !window.webrtcManager.localStream) {
            alert('Please start a WebRTC stream first to test admin audio.');
            return;
        }
        ...
        if (audioTrack && audioTrack.enabled) {
            ...
            alert('Admin microphone is not active. Please check your microphone permissions.');
        }
