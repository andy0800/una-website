...
window.audioPipeline = {
    ...
    joinChannel: async function() {
        ...
        try {
            console.log('🔄 Attempting to join channel:', window.AGORA_CONFIG.channel);
            console.log('🔄 App ID:', window.AGORA_CONFIG.appId);
            ...
            let attempts = 0;
            while (this.agoraClient.connectionState !== 'CONNECTED' && attempts < 10) {
            ...
            if (this.agoraClient.connectionState === 'CONNECTED') {
                ...
                console.error('❌ Channel connection timeout. Final state:', this.agoraClient.connectionState);
                return false;
            }
        } catch (error) {
