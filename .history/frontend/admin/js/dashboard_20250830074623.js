...
function initializeUIComponents() {
    ...
    window.addEventListener('beforeunload', (event) => {
        ...
        // if (window.webrtcManager && window.webrtcManager.isLive) { // Removed WebRTC check
...
class StreamStateManager {
    ...
    async syncState() {
        try {
            // if (!window.webrtcManager) { // Removed WebRTC check
            //     console.warn('WebRTC manager not available for state sync');
            //     return;
            // }

            // Get current WebRTC state
            // const webrtcState = window.webrtcManager.getConnectionHealth(); // Removed WebRTC check
            // const isLive = window.webrtcManager.isLive; // Removed WebRTC check
            // const roomId = window.webrtcManager.roomId; // Removed WebRTC check

            // Validate state consistency
            const expectedState = this.determineExpectedState(); // Removed WebRTC check
            
            // if (this.currentState !== expectedState) { // Removed WebRTC check
    ...
    determineExpectedState() {
        // if (!isLive) return 'idle'; // Removed WebRTC check
        
        // if (webrtcState.connectionQuality === 'poor') return 'degraded'; // Removed WebRTC check
        // if (webrtcState.connectionQuality === 'excellent') return 'optimal'; // Removed WebRTC check
        
        return 'active'; // Placeholder for future state
    }
    ...
    updateUIState(state, webrtcData) {
        ...
        // if (qualityIndicator && webrtcData && webrtcData.webrtcState) { // Removed WebRTC check
...
function initializeWebRTCManager() {
    try {
        ...
        // if (typeof CustomWebRTCManager !== 'undefined') { // Removed WebRTC check
...
function startRecording() {
    try {
        ...
        // if (window.mediaRecorder && window.mediaRecorder.state === 'recording') { // Removed WebRTC check
...
function startMediaRecorder(lectureId) {
    try {
        // if (!window.webrtcManager || !window.webrtcManager.localStream) { // Removed WebRTC check
        //     throw new Error('No stream available for recording');
        // }
        
        // const stream = window.webrtcManager.localStream; // Removed WebRTC check
        
        // Create MediaRecorder
        // window.mediaRecorder = new MediaRecorder(stream, { // Removed WebRTC check
        //     mimeType: 'video/webm;codecs=vp9,opus'
        // });
        
        // const chunks = []; // Removed WebRTC check
        
        // window.mediaRecorder.ondataavailable = (event) => { // Removed WebRTC check
        //     if (event.data.size > 0) {
        //         chunks.push(event.data);
        //     }
        // };
        
        // window.mediaRecorder.onstop = () => { // Removed WebRTC check
        //     const blob = new Blob(chunks, { type: 'video/webm' });
        //     saveRecording(blob, lectureId);
        // };
        
        // Start recording
        // window.mediaRecorder.start(); // Removed WebRTC check
        // window.webrtcManager.isRecording = true; // Removed WebRTC check
        
        // Store lecture ID
        // window.currentLectureId = lectureId; // Removed WebRTC check
...
window.testAllFunctionality = async function() {
    try {
        ...
        // Test 4: Media Access
        // const stream = await navigator.mediaDevices.getUserMedia({ video: true, audio: true }); // Removed WebRTC check
