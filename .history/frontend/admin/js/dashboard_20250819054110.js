...
function manageLectureAccess(lectureId) {
    // Create a simple access management modal
    const modalHtml = `
        <div id="accessModal" class="edit-modal" style="display: block;">
            <div class="edit-modal-content">
                ...
                <div class="edit-form">
                    ...
                    <div class="form-group">
                        <label>Individual User Access</label>
                        <div id="userAccessList" style="max-height: 200px; overflow-y: auto; border: 1px solid #ddd; padding: 10px; margin-top: 5px;">
...
function loadLectureAccessSettings(lectureId) {
    ...
    .catch(error => {
        ...
        document.getElementById('userAccessList').innerHTML = '<p style="color: #dc3545; text-align: center;">Error loading settings</p>';
    });
}
...
function testRecordedLecturesAPI() {
    ...
    .then(response => {
        ...
        console.log('📡 Test 1 Response Headers:', response.headers);
