...
class JitsiMeetManager {
    ...
    async joinRoom(roomId, options = {}) {
        try {
            ...
            // Create Jitsi Meet API instance - Use alternative server for public access
            const domain = '8x8.vc'; // Alternative Jitsi Meet server with different policies
            this.api = new JitsiMeetExternalAPI(domain, config);
