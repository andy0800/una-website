    ...
    function createPeerConnection() {
      ...
      pc.ontrack = (event) => {
        ...
        if (event.track.kind === 'video') {
          ...
          console.log('🔊 Received admin audio track');
          ...
          if (!window.adminAudioElement) {
            ...
            console.log('🎵 Created admin audio element');
          }
          ...
          console.log('🔊 Admin audio track added to audio element');
        }
      };
    ...
    async function handleMicrophoneAccess() {
      try {
        ...
        if (error.name === 'NotAllowedError') {
          alert('Microphone access denied. Please allow microphone permissions in your browser and refresh the page.');
