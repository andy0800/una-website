...
(() => {
  ...
  function showLectureError(message) {
    ...
    if (placeholder) {
      ...
      placeholder.innerHTML = `
        <i class="fas fa-exclamation-triangle"></i>
        <p>Error: ${message}</p>
        <button id="errorCloseBtn" class="lecture-error-retry">Close</button>
      `;
      
      // Add event listener to the close button
      const closeBtn = placeholder.querySelector('#errorCloseBtn');
      if (closeBtn) {
  ...
  // Add event delegation for lecture cards
