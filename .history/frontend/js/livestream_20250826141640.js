      ...
      try {
        ...
        if (!navigator.mediaDevices) {
          ...
          if (browserInfo.isMobile) {
            alert('Microphone access is not supported on this mobile device/browser.\n\n' +
                  'Please try:\n' +
                  '1. Using a different mobile browser (Chrome, Firefox, Safari)\n' +
                  '2. Accessing from a desktop computer\n' +
                  '3. Using the latest version of your browser');
          } else {
