...
(() => {
  ...
  async function initializeLivestream() {
    try {
      ...
      // Check if container exists (optional - will fallback to body if not found)
      const container = document.getElementById('jitsi-container');
      if (container) {
        console.log('✅ تم العثور على حاوية Jitsi');
      } else {
        console.log('⚠️ لم يتم العثور على حاوية Jitsi، سيتم استخدام body كبديل');
      }
