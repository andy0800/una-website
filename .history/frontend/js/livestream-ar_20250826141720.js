     ...
     async function handleMicrophoneAccess() {
       try {
         ...
         if (!navigator.mediaDevices) {
           ...
           // Mobile-specific error message in Arabic
           if (browserInfo.isMobile) {
             alert('الوصول للميكروفون غير مدعوم على هذا الجهاز المحمول/المتصفح.\n\n' +
                   'يرجى المحاولة:\n' +
                   '1. استخدام متصفح محمول مختلف (Chrome, Firefox, Safari)\n' +
                   '2. الوصول من جهاز كمبيوتر\n' +
                   '3. استخدام أحدث إصدار من متصفحك');
           } else {
