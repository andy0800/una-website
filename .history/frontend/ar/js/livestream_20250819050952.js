...
(() => {
  async function init() {
    console.log('🎥 تهيئة مشاهد البث المباشر...');
    
    // Initialize socket connection with better error handling
    let socket;
    try {
      const serverUrl = window.location.origin;
      console.log('🔌 الاتصال بخادم Socket.IO في:', serverUrl);
      ...
      console.error('❌ فشل في إنشاء اتصال Socket.IO:', error);
      alert('فشل في الاتصال بخادم البث. يرجى تحديث الصفحة.');
      return;
    }
