...
const securityHeaders = (req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdnjs.cloudflare.com https://cdn.quilljs.com https://cdn.socket.io https://download.agora.io",
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com https://cdn.quilljs.com",
    "font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com",
    "img-src 'self' data: https:",
    "media-src 'self' blob:",
            "connect-src 'self' ws: wss: https://download.agora.io https://*.agora.io https://*.sd-rtn.com https://webrtc2-*.agora.io https://statscollector-*.agora.io https://*.rtn.com https://statscollector-1.agora.io https://web-2.statscollector.sd-rtn.com https://webrtc2-2.ap.sd-rtn.com https://webrtc2-ap-web-3.agora.io https://webrtc2-4.ap.sd-rtn.com",
