...
const securityHeaders = (req, res, next) => {
  ...
  res.setHeader('Content-Security-Policy', [
    "default-src 'self'",
    "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdnjs.cloudflare.com https://cdn.quilljs.com https://cdn.socket.io https://meet.jit.si",
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com https://cdn.quilljs.com https://meet.jit.si",
    "font-src 'self' https://fonts.gstatic.com https://cdnjs.cloudflare.com https://meet.jit.si",
    "img-src 'self' data: https: https://meet.jit.si",
    "media-src 'self' blob: https://meet.jit.si",
    "connect-src 'self' ws: wss: https://meet.jit.si https://*.jit.si",
