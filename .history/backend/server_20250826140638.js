...
// 4. Create HTTPS server and bind Socket.IO
const httpsOptions = {
...
require('./socket/streamSocket')(io);
  ...
  server.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`🌐 Network accessible at: https://192.168.8.137:${PORT}`);
    console.log(`🏠 Local access: https://localhost:${PORT}`);
    console.log(`🔒 Microphone access now enabled across all browsers!`);
  });