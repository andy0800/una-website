...
// 7.1. Serve root-level files (including test-jitsi.html)
...
app.use('/api/jitsi',       require('./routes/jitsiRoutes')); // 🚀 Jitsi Meet livestreaming routes
...
require('./socket/streamSocket')(io);
  ...
  server.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`🌐 Network accessible at: http://192.168.8.137:${PORT}`);
    console.log(`🏠 Local access: http://localhost:${PORT}`);
    console.log(`🔧 Browser detection enabled - microphone access guidance provided`);
  });