...
router.post('/admin/lectures/:id/video', verifyAdminToken, upload.single('video'), async (req, res) => {
  try {
    ...
    console.log('💾 Saving lecture with filePath:', lecture.filePath);
    await lecture.save();
    console.log('✅ Lecture saved successfully with video file');
    
    // Verify the save operation
    const savedLecture = await RecordedLecture.findById(req.params.id);
    console.log('🔍 Verification - saved filePath:', savedLecture.filePath);
...
// Debug endpoint to check lecture details
