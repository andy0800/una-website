...
const isUserAuthenticated = require('../middleware/userAuthMiddleware'); // or adminAuthMiddleware if needed

// Protect English livestream
app.get('/frontend/en/livestream.html', isUserAuthenticated, (req, res) => {
