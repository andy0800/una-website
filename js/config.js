...
const config = {
  ...
  API_BASE_URL: 'https://una-website.onrender.com/api',
  SOCKET_URL: 'https://una-website.onrender.com',
  UPLOAD_URL: 'https://una-website.onrender.com/uploads',
  
  // Specific API endpoints
  USER_API: {
    LOGIN: 'https://una-website.onrender.com/api/users/login',
    REGISTER: 'https://una-website.onrender.com/api/users/register',
    PROFILE: 'https://una-website.onrender.com/api/users/me',
    COURSES: 'https://una-website.onrender.com/api/courses',
    ENROLL: 'https://una-website.onrender.com/api/users/enroll'
  },
