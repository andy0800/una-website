    ...
    async checkForCommonIssues(functionName, files) {
        ...
        for (const file of files) {
            if (file.endsWith('.js')) {
                ...
                // Check for console.log in frontend code only (backend console.log is appropriate)
                if (content.includes('console.log') && file.includes('frontend') && !file.includes('test')) {
